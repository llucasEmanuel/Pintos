...
// sleep list declarada extern no thread.h
...
thread_unblock (struct thread *t) 
{
  ...
  list_push_back (&ready_list, &t->elem); // TALVEZ SEJA INTERESSANTE FAZER INSERÇÃO ORDENADA, MAS SÓ ISSO N RESOLVE
